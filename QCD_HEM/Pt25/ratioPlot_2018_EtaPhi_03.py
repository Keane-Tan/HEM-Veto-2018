# run this only after you have run ratioPlot_2018_EtaPhi_01.py
...
EtaLow = np.arange(-3.0,-3.51,-0.05/2)[11:16]
EtaHigh = np.arange(-1.40,-0.89,0.05/2)[11:16]
PhiLow = np.arange(-1.57,-2.08,-0.05/2)[11:16]
PhiHigh = np.arange(-0.87,-0.36,0.05/2)[11:16]
